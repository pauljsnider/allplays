...
Pitching changes during an unfinished plate appearance are rejected across
substitution, re-entry, and defensive-alignment commands. Inherited-count
attribution is not implemented; complete the plate appearance before changing
the fielding pitcher. Do not represent this fail-closed limitation as support
for mid-plate-appearance pitching changes. DH and FLEX defensive histories are
tracked independently; DH termination is permanent for that game.
