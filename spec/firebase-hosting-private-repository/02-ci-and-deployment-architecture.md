...
| Production dispatch | Workflow and cloud-provider owner-ID gates, trusted `master` workflow version, first-attempt dispatch, immutable requested SHA, reachable merge, complete trusted evidence, one artifact |
