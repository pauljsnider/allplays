...
describe('live game overlay page', () => {
    it('ships as a separate no-index broadcast canvas with accessible overlay regions', () => {
        ...
        expect(html).toContain('js/live-game-overlay.js?v=36');
    });
    ...
    it('keeps the local demo isolated while wiring canonical subscriptions and authenticated chat posting', () => {
        ...
        expect(source).toContain("return import('./db.js?v=4433193')");
        ...
        expect(source).toContain("import('./auth.js?v=4433197')");
        ...
        expect(source).toContain("from './utils.js?v=443369'");
        ...
        expect(source).toContain("uiState.isReplay ? 'Standard replay view' : 'Standard live view'");
    ...
    it('provides focus, panel, keyboard, demo, and reciprocal viewer navigation', () => {
        ...
        expect(currentLiveGameSource).toContain("state.isReplay ? 'Replay overlay view' : 'Video overlay view'");
    });
