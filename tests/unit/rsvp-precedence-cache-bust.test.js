...
describe('RSVP precedence cache delivery', () => {
    it('uses the public-boundary db module key and versions the indirect staff breakdown graph', () => {
        ...
        const runtimeSources = {
            'accept-invite.html': 'db.js?v=4433192',
            'calendar.html': 'db.js?v=4433192',
            'edit-schedule.html': 'db.js?v=4433192',
            'game-day.html': 'db.js?v=4433192',
            'login.html': 'db.js?v=4433192',
            'parent-dashboard.html': 'db.js?v=4433192',
            'team.html': 'db.js?v=4433192',
            'team-chat.html': 'db.js?v=4433192',
            'js/auth.js': 'db.js?v=4433192',
            'profile.html': 'db.js?v=4433192',
            'js/team-media.js': 'db.js?v=4433192'
        };
    ...
    it('versions every deployed auth consumer after auth adopts the fresh db key', () => {
        const authConsumers = {
            'accept-invite.html': 'auth.js?v=4433196',
            'dashboard.html': 'auth.js?v=4433196',
            'edit-team.html': 'auth.js?v=4433196',
            'login.html': 'auth.js?v=4433196',
            'profile.html': 'auth.js?v=4433196',
            'parent-dashboard.html': 'auth.js?v=4433196',
            'js/admin.js': 'auth.js?v=4433196',
            'js/live-game.js': 'auth.js?v=4433196',
            'js/live-tracker.js': 'auth.js?v=4433196',
            'js/team-media.js': 'auth.js?v=4433196',
            'js/utils.js': 'auth.js?v=4433196'
        };
    ...
    it('propagates fresh keys through cached wrapper and shared utility entry modules', () => {
        const consumerVersions = {
            ...
            'certificates.html': 'js/certificates/studio.js?v=443361',
            'live-game.html': 'js/live-game.js?v=443346',
            'live-tracker.html': 'js/live-tracker.js?v=443325',
            'team-fees.html': 'js/team-fees-admin.js?v=443359',
            'team-media.html': 'js/team-media.js?v=44542',
            'track-basketball.html': 'js/track-basketball.js?v=443324',
            'tracking-items.html': 'js/tracking-items-admin.js?v=443357',
            'team.html': 'js/team-staff-permissions.js?v=443342',
            'game-day.html': 'js/team-admin-banner.js?v=443344'
        };
        ...
        expect(readRepoFile('js/utils.js')).toContain("import('./global-search.js?v=443350')");
        expect(readRepoFile('js/db.js')).toContain("from './utils.js?v=443368';");
        expect(readRepoFile('parent-dashboard.html')).toContain('js/utils.js?v=443368');
        expect(readRepoFile('js/live-game.js')).toContain("from './live-game-state.js?v=40';");
    });
