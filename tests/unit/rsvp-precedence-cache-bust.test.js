...
describe('RSVP precedence cache delivery', () => {
    it('uses the public-boundary db module key and versions the indirect staff breakdown graph', () => {
        ...
        const runtimeSources = {
            'accept-invite.html': 'db.js?v=4433153',
            'calendar.html': 'db.js?v=4433153',
            'edit-schedule.html': 'db.js?v=4433153',
            'game-day.html': 'db.js?v=4433153',
            'login.html': 'db.js?v=4433153',
            'parent-dashboard.html': 'db.js?v=4433153',
            'team.html': 'db.js?v=4433153',
            'team-chat.html': 'db.js?v=4433153',
            'js/auth.js': 'db.js?v=4433153',
            'profile.html': 'db.js?v=4433153',
            'js/team-media.js': 'db.js?v=4433153'
        };
    ...
    it('versions every deployed auth consumer after auth adopts the fresh db key', () => {
        const authConsumers = {
            'accept-invite.html': 'auth.js?v=4433157',
            'dashboard.html': 'auth.js?v=4433157',
            'edit-team.html': 'auth.js?v=4433157',
            'login.html': 'auth.js?v=4433157',
            'profile.html': 'auth.js?v=4433157',
            'parent-dashboard.html': 'auth.js?v=4433157',
            'js/admin.js': 'auth.js?v=4433157',
            'js/live-game.js': 'auth.js?v=4433157',
            'js/live-tracker.js': 'auth.js?v=4433157',
            'js/team-media.js': 'auth.js?v=4433157',
            'js/utils.js': 'auth.js?v=4433157'
        };
    ...
    it('propagates fresh keys through cached wrapper and shared utility entry modules', () => {
        const consumerVersions = {
            'admin.html': 'js/admin.js?v=443328',
            'certificates.html': 'js/certificates/studio.js?v=443328',
            'live-game.html': 'js/live-game.js?v=443330',
            'live-tracker.html': 'js/live-tracker.js?v=443312',
            'team-fees.html': 'js/team-fees-admin.js?v=443326',
            'team-media.html': 'js/team-media.js?v=443324',
            'track-basketball.html': 'js/track-basketball.js?v=443311',
            'tracking-items.html': 'js/tracking-items-admin.js?v=443325',
            'team.html': 'js/team-staff-permissions.js?v=443311',
            'game-day.html': 'js/team-admin-banner.js?v=443313'
        };
        ...
        expect(readRepoFile('js/utils.js')).toContain("import('./global-search.js?v=443319')");
        expect(readRepoFile('js/db.js')).toContain("from './utils.js?v=443331';");
        expect(readRepoFile('parent-dashboard.html')).toContain('js/utils.js?v=443331');
