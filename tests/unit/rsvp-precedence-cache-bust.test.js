...
describe('RSVP precedence cache delivery', () => {
    it('uses the public-boundary db module key and versions the indirect staff breakdown graph', () => {
        ...
        const runtimeSources = {
            'accept-invite.html': 'db.js?v=4433171',
            'calendar.html': 'db.js?v=4433171',
            'edit-schedule.html': 'db.js?v=4433171',
            'game-day.html': 'db.js?v=4433171',
            'login.html': 'db.js?v=4433171',
            'parent-dashboard.html': 'db.js?v=4433171',
            'team.html': 'db.js?v=4433171',
            'team-chat.html': 'db.js?v=4433171',
            'js/auth.js': 'db.js?v=4433171',
            'profile.html': 'db.js?v=4433171',
            'js/team-media.js': 'db.js?v=4433171'
        };
    ...
    it('versions every deployed auth consumer after auth adopts the fresh db key', () => {
        const authConsumers = {
            'accept-invite.html': 'auth.js?v=4433173',
            'dashboard.html': 'auth.js?v=4433173',
            'edit-team.html': 'auth.js?v=4433173',
            'login.html': 'auth.js?v=4433173',
            'profile.html': 'auth.js?v=4433173',
            'parent-dashboard.html': 'auth.js?v=4433173',
            'js/admin.js': 'auth.js?v=4433173',
            'js/live-game.js': 'auth.js?v=4433173',
            'js/live-tracker.js': 'auth.js?v=4433173',
            'js/team-media.js': 'auth.js?v=4433173',
            'js/utils.js': 'auth.js?v=4433173'
        };
    ...
    it('propagates fresh keys through cached wrapper and shared utility entry modules', () => {
        const consumerVersions = {
            ...
            'team.html': 'js/team-staff-permissions.js?v=443327',
            'game-day.html': 'js/team-admin-banner.js?v=443329'
        };
        ...
        expect(readRepoFile('js/utils.js')).toContain("import('./global-search.js?v=443335')");
        expect(readRepoFile('js/db.js')).toContain("from './utils.js?v=443347';");
        expect(readRepoFile('parent-dashboard.html')).toContain('js/utils.js?v=443347');
        expect(readRepoFile('js/live-game.js')).toContain("from './live-game-state.js?v=24';");
    });
