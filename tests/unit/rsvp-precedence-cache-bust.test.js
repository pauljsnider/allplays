...
describe('RSVP precedence cache delivery', () => {
    it('uses one fresh db module key and versions the indirect staff breakdown graph', () => {
        ...
        const runtimeSources = {
            'accept-invite.html': 'db.js?v=112',
            'calendar.html': 'db.js?v=112',
            'edit-schedule.html': 'db.js?v=112',
            'game-day.html': 'db.js?v=112',
            'login.html': 'db.js?v=112',
            'parent-dashboard.html': 'db.js?v=112',
            'team.html': 'db.js?v=112',
            'team-chat.html': 'db.js?v=112',
            'js/auth.js': 'db.js?v=112',
            'profile.html': 'db.js?v=112',
            'js/team-media.js': 'db.js?v=112'
        };
    ...
    it('versions every deployed auth consumer after auth adopts the fresh db key', () => {
        const authConsumers = {
            'accept-invite.html': 'auth.js?v=124',
            'dashboard.html': 'auth.js?v=124',
            'edit-team.html': 'auth.js?v=124',
            'login.html': 'auth.js?v=124',
            'profile.html': 'auth.js?v=124',
            'parent-dashboard.html': 'auth.js?v=124',
            'js/admin.js': 'auth.js?v=124',
            'js/live-game.js': 'auth.js?v=124',
            'js/live-tracker.js': 'auth.js?v=124',
            'js/team-media.js': 'auth.js?v=124',
            'js/utils.js': 'auth.js?v=124'
        };
