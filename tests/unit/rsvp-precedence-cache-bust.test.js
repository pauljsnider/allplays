...
describe('RSVP precedence cache delivery', () => {
    it('uses one fresh db module key and versions the indirect staff breakdown graph', () => {
        ...
        const runtimeSources = {
            'accept-invite.html': 'db.js?v=114',
            'calendar.html': 'db.js?v=114',
            'edit-schedule.html': 'db.js?v=114',
            'game-day.html': 'db.js?v=114',
            'login.html': 'db.js?v=114',
            'parent-dashboard.html': 'db.js?v=114',
            'team.html': 'db.js?v=114',
            'team-chat.html': 'db.js?v=114',
            'js/auth.js': 'db.js?v=114',
            'profile.html': 'db.js?v=114',
            'js/team-media.js': 'db.js?v=114'
        };
    ...
    it('versions every deployed auth consumer after auth adopts the fresh db key', () => {
        const authConsumers = {
            'accept-invite.html': 'auth.js?v=128',
            'dashboard.html': 'auth.js?v=128',
            'edit-team.html': 'auth.js?v=128',
            'login.html': 'auth.js?v=128',
            'profile.html': 'auth.js?v=128',
            'parent-dashboard.html': 'auth.js?v=128',
            'js/admin.js': 'auth.js?v=128',
            'js/live-game.js': 'auth.js?v=128',
            'js/live-tracker.js': 'auth.js?v=128',
            'js/team-media.js': 'auth.js?v=128',
            'js/utils.js': 'auth.js?v=128'
        };
