...
describe('RSVP precedence cache delivery', () => {
    ...
    it('propagates fresh keys through cached wrapper and shared utility entry modules', () => {
        const consumerVersions = {
            'admin.html': 'js/admin.js?v=24',
            'certificates.html': 'js/certificates/studio.js?v=20',
            'live-game.html': 'js/live-game.js?v=25',
            'live-tracker.html': 'js/live-tracker.js?v=8',
            'team-fees.html': 'js/team-fees-admin.js?v=21',
            'team-media.html': 'js/team-media.js?v=20',
            'track-basketball.html': 'js/track-basketball.js?v=7',
            'tracking-items.html': 'js/tracking-items-admin.js?v=20',
            'team.html': 'js/team-staff-permissions.js?v=7',
            'game-day.html': 'js/team-admin-banner.js?v=9'
        };
        ...
        expect(readRepoFile('js/utils.js')).toContain("import('./global-search.js?v=14')");
        expect(readRepoFile('js/db.js')).toContain("from './utils.js?v=19';");
        expect(readRepoFile('parent-dashboard.html')).toContain('js/utils.js?v=19');
