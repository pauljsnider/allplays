...
describe('RSVP precedence cache delivery', () => {
    it('uses the public-boundary db module key and versions the indirect staff breakdown graph', () => {
        ...
        const runtimeSources = {
            'accept-invite.html': 'db.js?v=4433157',
            'calendar.html': 'db.js?v=4433157',
            'edit-schedule.html': 'db.js?v=4433157',
            'game-day.html': 'db.js?v=4433157',
            'login.html': 'db.js?v=4433157',
            'parent-dashboard.html': 'db.js?v=4433157',
            'team.html': 'db.js?v=4433157',
            'team-chat.html': 'db.js?v=4433157',
            'js/auth.js': 'db.js?v=4433157',
            'profile.html': 'db.js?v=4433157',
            'js/team-media.js': 'db.js?v=4433157'
        };
    ...
    it('versions every deployed auth consumer after auth adopts the fresh db key', () => {
        const authConsumers = {
            'accept-invite.html': 'auth.js?v=4433161',
            'dashboard.html': 'auth.js?v=4433161',
            'edit-team.html': 'auth.js?v=4433161',
            'login.html': 'auth.js?v=4433161',
            'profile.html': 'auth.js?v=4433161',
            'parent-dashboard.html': 'auth.js?v=4433161',
            'js/admin.js': 'auth.js?v=4433161',
            'js/live-game.js': 'auth.js?v=4433161',
            'js/live-tracker.js': 'auth.js?v=4433161',
            'js/team-media.js': 'auth.js?v=4433161',
            'js/utils.js': 'auth.js?v=4433161'
        };
    ...
    it('propagates fresh keys through cached wrapper and shared utility entry modules', () => {
        const consumerVersions = {
            ...
            'certificates.html': 'js/certificates/studio.js?v=443332',
            'live-game.html': 'js/live-game.js?v=443332',
            'live-tracker.html': 'js/live-tracker.js?v=443314',
            'team-fees.html': 'js/team-fees-admin.js?v=443330',
            'team-media.html': 'js/team-media.js?v=44531',
            'track-basketball.html': 'js/track-basketball.js?v=443313',
            'tracking-items.html': 'js/tracking-items-admin.js?v=443329',
            'team.html': 'js/team-staff-permissions.js?v=443315',
            'game-day.html': 'js/team-admin-banner.js?v=443317'
        };
        ...
        expect(readRepoFile('js/utils.js')).toContain("import('./global-search.js?v=443323')");
        expect(readRepoFile('js/db.js')).toContain("from './utils.js?v=443335';");
        expect(readRepoFile('parent-dashboard.html')).toContain('js/utils.js?v=443335');
        expect(readRepoFile('js/live-game.js')).toContain("from './live-game-state.js?v=12';");
    });
