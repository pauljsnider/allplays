...
describe('RSVP precedence cache delivery', () => {
    it('uses the public-boundary db module key and versions the indirect staff breakdown graph', () => {
        ...
        const runtimeSources = {
            'accept-invite.html': 'db.js?v=146',
            'calendar.html': 'db.js?v=146',
            'edit-schedule.html': 'db.js?v=146',
            'game-day.html': 'db.js?v=146',
            'login.html': 'db.js?v=146',
            'parent-dashboard.html': 'db.js?v=146',
            'team.html': 'db.js?v=146',
            'team-chat.html': 'db.js?v=146',
            'js/auth.js': 'db.js?v=146',
            'profile.html': 'db.js?v=146',
            'js/team-media.js': 'db.js?v=146'
        };
    ...
    it('versions every deployed auth consumer after auth adopts the fresh db key', () => {
        const authConsumers = {
            'accept-invite.html': 'auth.js?v=150',
            'dashboard.html': 'auth.js?v=150',
            'edit-team.html': 'auth.js?v=150',
            'login.html': 'auth.js?v=150',
            'profile.html': 'auth.js?v=150',
            'parent-dashboard.html': 'auth.js?v=150',
            'js/admin.js': 'auth.js?v=150',
            'js/live-game.js': 'auth.js?v=150',
            'js/live-tracker.js': 'auth.js?v=150',
            'js/team-media.js': 'auth.js?v=150',
            'js/utils.js': 'auth.js?v=150'
        };
    ...
    it('propagates fresh keys through cached wrapper and shared utility entry modules', () => {
        const consumerVersions = {
            ...
            'certificates.html': 'js/certificates/studio.js?v=24',
            ...
            'team.html': 'js/team-staff-permissions.js?v=10',
            'game-day.html': 'js/team-admin-banner.js?v=12'
        };
        ...
        expect(readRepoFile('js/utils.js')).toContain("import('./global-search.js?v=17')");
        expect(readRepoFile('js/db.js')).toContain("from './utils.js?v=25';");
        expect(readRepoFile('parent-dashboard.html')).toContain('js/utils.js?v=25');
