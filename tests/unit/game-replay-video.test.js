...
describe('YouTube game replay URLs', () => {
    ...
    it.each([
        ...
        [{ type: null, status: 'completed', liveStatus: 'scheduled' }, false, false],
        [{ type: '', status: 'completed', liveStatus: 'scheduled' }, false, false],
        [{ type: ' game ', status: 'completed', liveStatus: 'scheduled' }, false, false],
        [{ type: 'practice', status: 'scheduled', liveStatus: 'live' }, false, false],
        [{ type: null, status: 'scheduled', liveStatus: 'live' }, false, false],
        [{ status: ' FINAL ', liveStatus: 'scheduled' }, false, false],
        [{ status: 'FINAL', liveStatus: 'scheduled' }, false, false],
        [{ status: 'complete', liveStatus: 'scheduled' }, false, false],
        [{ status: 'finished', liveStatus: 'scheduled' }, false, false],
        [{ status: 'scheduled', liveStatus: ' LIVE ' }, false, false],
        [{ status: 'SCHEDULED', liveStatus: 'live' }, false, false],
        ...
        [{ status: null, liveStatus: 'completed' }, true, false],
        [{ status: 'completed', liveStatus: null }, true, false],
