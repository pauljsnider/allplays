...
describe('app push notification routing', () => {
    ...
    it('maps live chat, live score, and schedule payloads to app routes', () => {
        ...
        expect(resolvePushNotificationRoute({ category: 'liveScore', teamId: 'team-1', gameId: 'game-7' })).toBe('/games/game-7');
    ...
    it('falls back to legacy web links when an explicit app route is absent', () => {
        ...
        expect(resolvePushNotificationRoute({ link: 'https://allplays.ai/live-game.html?teamId=team-1&gameId=game-7' })).toBe('/games/game-7');
