...
` + match[1]
        ...
        .replace("import { functions, httpsCallable } from './js/firebase.js?v=32';", 'const { functions, httpsCallable } = deps.firebase;')
        ...
        .replace("import { renderFamilyPlanSection } from './js/family-plan.js?v=11';", 'const { renderFamilyPlanSection } = deps.familyPlan;')
