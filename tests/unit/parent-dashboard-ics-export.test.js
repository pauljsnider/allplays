...
` + match[1]
        ...
        .replace("import { functions, httpsCallable } from './js/firebase.js?v=24';", 'const { functions, httpsCallable } = deps.firebase;')
        ...
        .replace("import { renderFamilyPlanSection } from './js/family-plan.js?v=7';", 'const { renderFamilyPlanSection } = deps.familyPlan;')
