...
` + match[1]
        ...
        .replace("import { functions, httpsCallable } from './js/firebase.js?v=27';", 'const { functions, httpsCallable } = deps.firebase;')
        ...
        .replace("import { renderFamilyPlanSection } from './js/family-plan.js?v=10';", 'const { renderFamilyPlanSection } = deps.familyPlan;')
