...
` + match[1]
        ...
        .replace("import { functions, httpsCallable } from './js/firebase.js?v=25';", 'const { functions, httpsCallable } = deps.firebase;')
        ...
        .replace("import { renderFamilyPlanSection } from './js/family-plan.js?v=8';", 'const { renderFamilyPlanSection } = deps.familyPlan;')
