...
` + match[1]
        ...
        .replace("import { renderFamilyPlanSection } from './js/family-plan.js?v=12';", 'const { renderFamilyPlanSection } = deps.familyPlan;')
...
function createDeps() {
    return {
        ...
        firebase: {
            functions: {},
            httpsCallable() { return async () => ({ data: {} }); }
        },
        utils: {
            renderHeader() {},
            renderFooter() {},
