...
describe('awards and certificates workflow wiring', () => {
    it('adds the certificates studio page with the expected workflow mount points', () => {
        ...
        expect(html).toContain('./js/certificates/studio.js?v=443367');
        expect(studio).toContain("from './templates.js?v=2'");
        expect(studio).toContain("from './renderer.js?v=2'");
        expect(studio).toContain("from './aiDescriptions.js?v=5'");
        ...
        expect(studio).toContain("from '../db.js?v=4433198'");
        expect(db).toContain("from './certificates/persistence.js?v=7'");
        expect(db).toContain('return commitCertificateDefaults(teamId, defaults);');
        expect(studio).toContain("import('./assets.js?v=13')");
