...
describe('awards and certificates workflow wiring', () => {
    it('adds the certificates studio page with the expected workflow mount points', () => {
        ...
        expect(html).toContain('./js/certificates/studio.js?v=443356');
        ...
        expect(studio).toContain("from '../db.js?v=4433183'");
        expect(db).toContain("from './certificates/persistence.js?v=5'");
        expect(db).toContain('return commitCertificateDefaults(teamId, defaults);');
        expect(studio).toContain("import('./assets.js?v=11')");
