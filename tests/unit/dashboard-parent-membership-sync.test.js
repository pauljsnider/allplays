...
describe('dashboard parent membership sync', () => {
    ...
    it('uses the rich auth path before loading parent-linked teams', () => {
        expect(html).toContain("import { getTeams, getUserTeamsWithAccess, getParentTeams, deleteTeam, getUserProfile, getUnreadChatCounts } from './js/db.js?v=4433162';");
        expect(html).toContain("import { checkAuth } from './js/auth.js?v=4433164';");
