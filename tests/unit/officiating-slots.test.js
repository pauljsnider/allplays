...
describe('officiating slots', () => {
    ...
    it('adds quick final score submission and submitted-result state to accepted official assignments', () => {
        ...
        expect(officialsSource).toContain("'./js/db.js?v=4433172'");
        expect(officialsSource).not.toContain("'./js/db.js?v=48'");
        expect(officialsSource).not.toContain("'./js/db.js?v=72'");
