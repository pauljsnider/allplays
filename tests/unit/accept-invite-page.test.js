...
` + match[1]
        .replace(
            "import { isEmailSignInLink, completeEmailLinkSignIn, checkAuth, getRedirectUrl } from './js/auth.js?v=4433165';",
        ...
        .replace(
            "import { renderHeader, renderFooter } from './js/utils.js?v=443339';",
