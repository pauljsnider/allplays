...
vi.mock('../../js/db.js?v=4433196', () => adminDbMocks);
vi.mock('../../js/firebase.js?v=34', () => adminFirebaseMocks);
vi.mock('../../js/utils.js?v=443372', () => ({
    renderHeader: vi.fn(),
    renderFooter: vi.fn(),
    escapeHtml: (value) => String(value || '')
}));
vi.mock('../../js/auth.js?v=4433200', () => adminAuthMocks);
vi.mock('../../js/admin-premium-access-control.js?v=8', () => ({
