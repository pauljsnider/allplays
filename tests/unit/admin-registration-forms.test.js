...
vi.mock('../../js/db.js?v=4433197', () => adminDbMocks);
vi.mock('../../js/firebase.js?v=33', () => adminFirebaseMocks);
vi.mock('../../js/utils.js?v=443373', () => ({
    renderHeader: vi.fn(),
    renderFooter: vi.fn(),
    escapeHtml: (value) => String(value || '')
}));
vi.mock('../../js/auth.js?v=4433201', () => adminAuthMocks);
...
describe('admin registration form setup', () => {
    ...
    it('wires the admin dashboard to create, edit, publish, and copy registration links', () => {
        ...
        expect(adminPage).toContain('src="js/admin.js?v=443361"');
