...
async function mockEditTeamDependencies(page) {
    ...
    await page.route('**/js/auth.js?v=11', (route) => route.fulfill({ status: 200, contentType: 'application/javascript', body: EDIT_TEAM_AUTH_STUB }));
...
async function mockAcceptInviteDependencies(page) {
    ...
    await page.route('**/js/auth.js?v=11', (route) => route.fulfill({ status: 200, contentType: 'application/javascript', body: ACCEPT_INVITE_AUTH_STUB }));
