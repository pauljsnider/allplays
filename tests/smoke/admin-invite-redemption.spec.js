...
async function mockEditTeamDependencies(page) {
    ...
    await page.route('**/js/utils.js?v=17', (route) => route.fulfill({ status: 200, contentType: 'application/javascript', body: EDIT_TEAM_UTILS_STUB }));
...
async function mockAcceptInviteDependencies(page) {
    ...
    await page.route('**/js/utils.js?v=17', (route) => route.fulfill({ status: 200, contentType: 'application/javascript', body: SHARED_UTILS_STUB }));
}
