...
function buildLiveGameShareParams({ teamId, gameId, replay, clipStart, clipEnd, overlay, classic } = {}) {
  ...
  if (overlay === true || overlay === 'true' || overlay === '1') params.set('overlay', 'true');
