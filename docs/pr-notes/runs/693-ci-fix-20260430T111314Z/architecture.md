...
- Update the smoke test interception from `db.js?v=15` to `db.js?v=16` because `team.html` now imports `./js/db.js?v=16`.
...
- Rollback by reverting the smoke route update if `team.html` returns to `db.js?v=15`.
