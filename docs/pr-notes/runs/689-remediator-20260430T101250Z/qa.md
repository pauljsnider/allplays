...
## QA Plan
- Static inspection: confirm `team.html` imports `./js/db.js?v=17` for `saveTeamAvailabilityPreferences`.
- Static inspection: confirm `game-day.html` imports `./js/db.js?v=17` and passes `skipAvailabilityCutoff: true` only through the coach override wrapper.
