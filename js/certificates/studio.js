...
import { renderHeader, renderFooter, escapeHtml, shareOrCopy } from '../utils.js?v=443364';
import { renderTeamAdminBanner, getTeamAccessInfo } from '../team-admin-banner.js?v=443340';
...
function bindSetupEvents() {
    ...
    document.querySelectorAll('[data-image-upload]').forEach((input) => {
        input.addEventListener('change', async () => {
            ...
            try {
                ...
                const { uploadCertificateAsset } = await import('./assets.js?v=12');
    ...
    document.querySelectorAll('[data-signature-upload]').forEach((input) => {
        input.addEventListener('change', async () => {
            ...
            try {
                const { deleteSignatureImage, uploadSignatureImage } = await import('./assets.js?v=12');
