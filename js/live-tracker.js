...
import { getTeam, getGameDayTeamContext, getTeams, getGame, getPlayers, getConfigs, updateGame, collection, getDocs, deleteDoc, query, broadcastLiveEvent, subscribeLiveChat, postLiveChatMessage, setGameLiveStatus } from './db.js?v=4433196';
...
import { writeBatch, doc, setDoc, addDoc, onSnapshot, serverTimestamp } from './firebase.js?v=34';
...
import { resolveLiveStatConfig, resolveLiveStatColumns } from './live-game-state.js?v=43';
...
import { buildOpponentStatsSnapshotFromEntries } from './live-tracker-finish.js?v=5';
import {
