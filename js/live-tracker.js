...
import { getTeam, getGameDayTeamContext, getTeams, getGame, getPlayers, getConfigs, updateGame, collection, getDocs, deleteDoc, query, broadcastLiveEvent, subscribeLiveChat, postLiveChatMessage, setGameLiveStatus } from './db.js?v=4433191';
import { db } from './firebase.js?v=33';
import { getUrlParams, escapeHtml } from './utils.js?v=443367';
...
import { resolveLiveStatConfig, resolveLiveStatColumns } from './live-game-state.js?v=39';
