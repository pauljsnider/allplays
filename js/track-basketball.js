...
import { getGameDayTeamContext, getGame, getPlayers, getConfigs, updateGame, getMyRsvp, collection, getDocs, deleteDoc, query } from './db.js?v=4433169';
...
import { writeBatch, doc, setDoc, addDoc } from './firebase.js?v=25';
