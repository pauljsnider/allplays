...
export const capabilities: Capability[] = [
  ...
  capability('edit-team', 'Team settings', 'edit-team.html', 'Teams', 'Native team settings now cover basic staff-owned fields in the app: name, sport, photo, ZIP, and visibility.', ['Team settings', 'Team photo', 'Sport', 'Visibility', 'ZIP'], '/teams/team-bears/edit', 'native-shell', staffRoles),
