...
export const capabilities: Capability[] = [
  ...
  capability('track-standard', 'Standard game tracker', 'track.html', 'Tracking', 'Stat entry, timer, opponent stats, undo, AI summary, email recap, and finish flow.', ['Stat entry', 'Timer', 'Opponent stats', 'Undo', 'AI summary', 'Email recap', 'Finish flow'], '/schedule', 'native-shell', staffRoles),
