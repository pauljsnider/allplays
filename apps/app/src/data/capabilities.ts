...
export const capabilities: Capability[] = [
  ...
  capability('edit-team', 'Team settings', 'edit-team.html', 'Teams', 'Native team settings now cover staff-owned basics plus league and livestream links in the app: name, sport, photo, ZIP, visibility, league page, and stream management.', ['Team settings', 'Team photo', 'Sport', 'Visibility', 'ZIP', 'League link', 'Livestream link'], '/teams/team-bears/edit', 'native-shell', staffRoles),
  capability('edit-roster', 'Roster management', 'edit-roster.html', 'Roster', 'Native roster now covers add-player, editing existing player details and photos, parent invites, and deactivate/reactivate. Legacy still owns AI import, registration sync, printable roster options, and tracking status administration.', ['Native add player', 'Edit players', 'Photo replacement', 'Staff visibility', 'Deactivate/reactivate', 'Parent invites', 'Custom fields', 'AI roster import', 'Registration sync', 'Printable roster', 'Tracking statuses'], undefined, 'stub', staffRoles),
  ...
  capability('edit-config', 'Stat configuration', 'edit-config.html', 'Tracking', 'Native team detail now supports stat configs: preset or blank creation, config renaming, base sport selection, and column add/remove/reorder/editing with legacy-compatible payloads.', ['Preset creation', 'Blank creation', 'Config rename', 'Base sport selection', 'Column add/remove/reorder', 'Legacy-compatible payloads'], '/teams/team-bears?tab=more', 'native-shell', staffRoles),
  capability('tracking-items', 'Tracking item setup', 'tracking-items.html', 'Roster', 'Native roster now supports legacy-compatible tracking item setup, active-roster tracking statuses, and staff-only admin controls in the app.', ['Tracking setup', 'Roster statuses', 'Admin controls'], '/teams/team-bears?tab=roster', 'native-shell', staffRoles),
  ...
  capability('registration', 'Public registration', 'registration.html', 'Registration', 'Native app now supports public registration submission plus staff application review, waitlist promotion, and roster merge; legacy still owns setup.', ['Registration options', 'Participant details', 'Guardian details', 'Waivers', 'Fees', 'Payment plans', 'Staff application review', 'Waitlist promotion', 'Roster merge'], undefined, 'native-shell', parentRoles),
  capability('organization-schedule', 'Organization schedule', 'organization-schedule.html', 'Schedule', 'Organization schedule stays future-scoped for native support; staff keep using the web flow for shared matchups, venue availability, blackouts, CSV import, draft generation, and organization venues.', ['Future native scope', 'Shared matchups', 'Venue availability', 'Blackouts', 'CSV import', 'Draft generation', 'Organization venues'], undefined, 'future', staffRoles),
  capability('officials', 'Officials assignments', 'officials.html', 'Schedule', 'Upcoming assignments, accept/decline assignments, and claim open slots.', ['Upcoming assignments', 'Accept/decline', 'Claim open slots'], '/officials', 'native-shell', staffRoles),
  ...
  capability('track-standard', 'Standard game tracker', 'track.html', 'Tracking', 'App game hub now supports legacy-compatible timer start/pause, period advance, live scoring context, opponent stats, undo, AI summary, email recap, and finish flow.', ['Stat entry', 'Timer start/pause', 'Period advance', 'Opponent stats', 'Undo', 'AI summary', 'Email recap', 'Finish flow'], '/schedule', 'native-shell', staffRoles),
  capability('track-live', 'Live broadcast tracker', 'track-live.html', 'Tracking', 'App game hub now supports persisted live clock anchors, period context, score updates, and live play-by-play publishing from the schedule game hub.', ['Persisted live clock', 'Period context', 'Score updates', 'Live play-by-play publish'], '/schedule', 'native-shell', staffRoles),
  capability('live-tracker', 'Basketball live tracker', 'live-tracker.html', 'Tracking', 'App game hub now supports the persisted basketball clock, period advance, personal fouls, team foul bonus indicators, substitutions, opponent stats, and finish flow.', ['Clock', 'Period advance', 'Personal fouls', 'Team foul bonus', 'Substitutions', 'Opponent stats', 'Finish flow'], '/schedule', 'native-shell', staffRoles),
  ...
  capability('workflow-registration', 'Registration workflow', 'workflow-registration.html', 'Workflow', 'Registration setup, native application review, waitlist, and Sports Connect metadata import workflow.', ['Registration setup', 'Native application review', 'Waitlist', 'Sports Connect metadata import']),
