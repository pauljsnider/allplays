...
export const capabilities: Capability[] = [
  ...
  capability('team-fees', 'Team fees', 'team-fees.html', 'Fees', 'Simple fee creation, recipient balances, parent fee visibility, offline payments, refunds, adjustments, and cancellations.', ['Fee creation', 'Recipient balances', 'Parent fee visibility', 'Offline payments', 'Refunds', 'Adjustments', 'Cancellations'], '/teams/team-bears/fees', 'native-shell', staffRoles),
