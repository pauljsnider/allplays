...
export const capabilities: Capability[] = [
  ...
  capability('teams-browse', 'Browse teams', 'teams.html', 'Teams', 'Browse public teams, team discovery, and search.', ['Public teams', 'Discovery', 'Search']),
  ...
  capability('edit-team', 'Team settings', 'edit-team.html', 'Teams', 'Team settings, sport, visibility, league links, stream links, staff/admin invites, and registration setup.', ['Team settings', 'Sport', 'Visibility', 'League link', 'Livestream link', 'ZIP', 'Staff/admin invites', 'Registration setup'], undefined, 'stub', staffRoles),
  capability('edit-roster', 'Roster management', 'edit-roster.html', 'Roster', 'Add/edit players, deactivate/reactivate, parent invites, custom fields, AI import, registration sync, and tracking statuses.', ['Add players', 'Edit players', 'Deactivate/reactivate', 'Parent invites', 'Custom fields', 'AI roster import', 'Registration sync', 'Tracking statuses'], undefined, 'stub', staffRoles),
  ...
  capability('team-fees', 'Team fees', 'team-fees.html', 'Fees', 'Fee creation, recipient balances, installments, Stripe checkout links, offline payments, adjustments, and cancellations.', ['Fee creation', 'Recipient balances', 'Installments', 'Stripe checkout links', 'Offline payments', 'Adjustments', 'Cancellations'], undefined, 'stub', staffRoles),
  ...
  capability('drills', 'Practice command center', 'drills.html', 'Game Day', 'Drill library, team drills, favorites, AI coach, practice timeline, attendance, notes, and home packets.', ['Drill library', 'Team drills', 'Favorites', 'AI coach', 'Practice timeline', 'Attendance', 'Notes', 'Home packets'], undefined, 'stub', staffRoles),
  capability('game-plan', 'Game planning', 'game-plan.html', 'Game Day', 'Lineup planning, autosave, and game-day handoff.', ['Game planning', 'Lineup planning', 'Autosave', 'Game-day handoff'], undefined, 'stub', staffRoles),
  capability('game-day', 'Game day command center', 'game-day.html', 'Game Day', 'RSVP breakdown, lineup builder, AI lineup, substitutions, live logs, wrap-up, AI analysis, and practice feed.', ['RSVP breakdown', 'Lineup builder', 'AI lineup', 'Substitutions', 'Live logs', 'Score wrap-up', 'AI analysis', 'Practice feed'], undefined, 'stub', staffRoles),
  ...
  capability('track-live', 'Live broadcast tracker', 'track-live.html', 'Tracking', 'Live scorekeeping, chat, game log, notes, and replay data.', ['Live scorekeeping', 'Chat', 'Game log', 'Notes', 'Replay data'], undefined, 'stub', staffRoles),
  ...
  capability('track-statsheet', 'Statsheet import', 'track-statsheet.html', 'Tracking', 'Photo statsheet import, score sheet mapping, stat review, and apply stats.', ['Photo import', 'Score sheet mapping', 'Stat review', 'Apply stats'], undefined, 'stub', staffRoles),
  ...
  capability('athlete-profile-builder', 'Athlete profile builder', 'athlete-profile-builder.html', 'Player', 'Headshot upload, season selection, career stats, highlight clips, and share settings.', ['Headshot upload', 'Season selection', 'Career stats', 'Highlight clips', 'Share settings'], undefined, 'stub', parentRoles),
  ...
  capability('workflow-roster', 'Roster workflow', 'workflow-roster.html', 'Workflow', 'Roster build, roster import, parent invite, and player status workflow.', ['Roster build', 'Roster import', 'Parent invite', 'Player status']),
