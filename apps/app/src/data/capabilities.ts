...
export const capabilities: Capability[] = [
  ...
  capability('registration', 'Public registration', 'registration.html', 'Registration', 'Native app now supports public registration submission plus staff application review with approve/decline and roster merge; legacy still owns setup and waitlist management.', ['Registration options', 'Participant details', 'Guardian details', 'Waivers', 'Fees', 'Payment plans', 'Staff application review', 'Roster merge'], undefined, 'native-shell', parentRoles),
