...
export const capabilities: Capability[] = [
  ...
  capability('edit-roster', 'Roster management', 'edit-roster.html', 'Roster', 'Native roster now covers add-player, parent invites, and deactivate/reactivate. Legacy still owns editing existing players, AI import, registration sync, printable roster options, and tracking status administration.', ['Native add player', 'Edit players', 'Staff visibility', 'Deactivate/reactivate', 'Parent invites', 'Custom fields', 'AI roster import', 'Registration sync', 'Printable roster', 'Tracking statuses'], undefined, 'stub', staffRoles),
