...
export const capabilities: Capability[] = [
  ...
  capability('track-live', 'Live broadcast tracker', 'track-live.html', 'Tracking', 'App game hub now supports persisted live clock anchors, period context, live scorekeeping, chat, game log, notes, and replay data.', ['Persisted live clock', 'Period context', 'Live scorekeeping', 'Chat', 'Game log', 'Notes', 'Replay data'], '/schedule', 'native-shell', staffRoles),
