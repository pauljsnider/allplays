...
const routePreloaders: Array<{ pattern: RegExp; load: () => Promise<unknown> }> = [
  ...
  { pattern: /^\/discover$/, load: () => import('../pages/Discover') },
  { pattern: /^\/discover\/new$/, load: () => import('../pages/OpportunityForm') },
  { pattern: /^\/discover\/opportunities\/[^/]+$/, load: () => import('../pages/OpportunityDetail') },
  { pattern: /^\/discover\/opportunities\/[^/]+\/edit$/, load: () => import('../pages/OpportunityForm') },
  { pattern: /^\/discover\/manage$/, load: () => import('../pages/OpportunityManage') },
  { pattern: /^\/discover\/inquiries\/[^/]+$/, load: () => import('../pages/OpportunityInquiry') },
