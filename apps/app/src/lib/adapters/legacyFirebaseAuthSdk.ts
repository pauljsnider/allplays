...
import {
  ...
  signInWithCustomToken as legacySignInWithCustomToken,
...
export const signInWithCustomToken = legacySignInWithCustomToken as (...args: any[]) => Promise<any>;
...
export const setPersistence = legacySetPersistence as (...args: any[]) => Promise<any>;
