...
export type DiamondTeamLineup = Readonly<{
  ...
  /** Effective game-long role history; older checkpoints may lack this evidence. */
  courtesyRunnerRoles?: readonly Readonly<{ playerId: string; forRole: 'pitcher' | 'catcher' }>[];
...
export type DiamondGameState = Readonly<{
  ...
  /** Mandatory one-base runner awards from a recorded baseball balk. */
  pendingBalkAwards?: readonly Readonly<{ runnerId: string; from: DiamondBase; to: DiamondBase | 'home' }>[];
